        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    ...
                    <textarea id="deskripsi" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" name="deskripsi"></textarea>
                </div>
                <button type="submit"
