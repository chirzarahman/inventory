        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @foreach ($user as $u)
                <form action="{{ route('user.update', $u->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="px-3 py-2 mt-4 text-sm font-medium text-center text-white float-right bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Submit</button>
                </form>
            @endforeach
        </div>
    </div>
